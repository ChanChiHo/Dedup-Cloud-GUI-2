...
public class hackGUI {
	...
	private void initHomePage() {
		...
		btnHack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println("GUI - Hack Button Pressed");
				
				Container cards = frame.getContentPane();
				CardLayout cl = (CardLayout) cards.getLayout();
				cl.show(cards, "Hack");
				System.out.println("GUI - [Page] Hack <- Home");
			}
		});
		btnHack.setBounds(166, 180, 117, 29);
		home.add(btnHack);
	}
	...
	private void initHackingPage() {
		JPanel hackingPage = new JPanel();
		frame.getContentPane().add(hackingPage, "Hack");
		hackingPage.setLayout(null);
		
		JLabel lblDownload = new JLabel("Download");
		lblDownload.setBounds(23, 16, 100, 16);
		hackingPage.add(lblDownload);
		
		txtFilename = new JTextField();
		txtFilename.setText("Filename");
		txtFilename.setBounds(33, 44, 130, 26);
		hackingPage.add(txtFilename);
		...
		btnDownload.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					client.close();
					client.connect(address,59090);
					int result = client.download(txtFilename.getText(), txtFilename.getText(),
							currentChunk, totalChunk, downloadTime, downloadProgressBar);
					client.close();
		...
		btnDownload.setBounds(183, 44, 117, 29);
		hackingPage.add(btnDownload);
		
		JLabel lblDelete = new JLabel("Delete");
		lblDelete.setBounds(23, 82, 61, 16);
		hackingPage.add(lblDelete);
		
		txtFilename_1 = new JTextField();
		txtFilename_1.setText("Filename");
		txtFilename_1.setBounds(33, 110, 130, 26);
		hackingPage.add(txtFilename_1);
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					client.close();
					client.connect();
					int result = client.delete(txtFilename_1.getText());
					txtResult.setText("Result = "+result);
		...
		btnDelete.setBounds(183, 111, 117, 29);
		hackingPage.add(btnDelete);
		
		txtResult = new JTextField();
		txtResult.setEditable(false);
		txtResult.setBounds(33, 184, 282, 26);
		hackingPage.add(txtResult);
		txtResult.setColumns(10);
		
		JLabel lblResult = new JLabel("Result");
		lblResult.setBounds(39, 166, 61, 16);
		hackingPage.add(lblResult);		
	}
}
